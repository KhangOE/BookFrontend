...
const Banner = () => {
  return (
    <div className="w-full h-fit flex flex-col items-center relative">
      ...
      <ul className="w-fit h-fit text-gray-600 text-center flex flex-row box-border bg-stone-200 opacity-80 absolute z-10 p-3 text-sm font-bold gap-x-5 md:p-4 hover:text-gray-900">
