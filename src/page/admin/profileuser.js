    ...
    <div  className='font-sans text-[#33333]' >
        ...
        <div className="sm:text-left text-center flex-1 sm:border-r-2 sm:border-b-0 border-b-2 border-dashed flex flex-col  sm:flex-row  gap-8">
          <div class='sm:m-auto m-0 flex justify-center'>
            <img src="https://mdbcdn.b-cdn.net/img/new/avatars/2.webp" className="rounded-full w-40" alt="Avatar" />
          </div>
          <div>
            <div className="font-hairline py-1 text-xl bold">Lasender Maverel</div>
            <div className="font-hairline pb-1 text-md italic">LoginName@lava</div>
            ...
            <div>
              <button className="bg-blue-300 h-10 rounded-sm w-auto px-6 m-6 bold">Send Message</button>
              <button className="bg-blue-300 h-10 rounded-sm w-auto px-6 m-6 bold">Ban</button>
            </div>
          </div>
        </div>
