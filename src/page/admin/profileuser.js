      ...
      <div className="font-sans text-[#33333] ">
        ...
        <div className='max-w-full overflow-hidden'>
          ...
          <table className="w-full overflow-scroll bg-white">
            <tr>
              <th className='w-[15%] text-start px-4'>
                ORDER
              </th>
              <th className='w-[15%] text-start px-4'>
                TOTAL
              </th>
              <th className='text-start px-4 w-[15%]'>
                PAYMENT STATUS
              </th>
            ...
            <tr>
              <td className='order font-semibold text-sm  text-sky-500 '>#2030x3</td>
